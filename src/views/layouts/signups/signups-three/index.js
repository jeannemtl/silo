...
class SignupsThree extends Component {
  render() {
    return (
      <Container className="white vh" textAlign="center">
        ...
        <Segment
          basic
          className="fullWidth thunderDarkGray noMargin noPadding overflowHidden bgCover headerMedium headerShapesSmall"
        >
        ...
        <Segment basic className="absolute toBottom fullWidth noMargin noPadding">
          <Segment basic className="textLeft w70 l25p">
            <Header as="h5" className="darkGray noMargin">
              SIGN UP VIA FACEBOOK
            </Header>
            <Segment basic className="separator thunderBlue noPadding" />
          </Segment>
